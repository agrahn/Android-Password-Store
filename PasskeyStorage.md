...
## Passkey data format
Passkey credentials are first serialised as CBOR binary data with keys sorted lexicographically and then encoded into a Base64URL string. The input to CBOR serialisation is as follows:
````kotlin
{
