...
public interface KeyManager<Key, KeyIdentifier> {
  ...
  /**
   * Creates a new EC-based OpenPGP key and inserts it into the store. [userId] is used as
   * primary user-id, the generated secret key is encrypted with [passphrase]
   */
