...
class PGPKeyManagerTest {
  ...
  private val keyManager by unsafeLazy { PGPKeyManager(filesDir.absolutePath) }
  ...
  fun addMultipleKeysWithSameEmail() {
    ...
    val userIds = arrayOf(UserId("Alice <owner@example.com>"), UserId("Bobby <owner@example.com>"))
