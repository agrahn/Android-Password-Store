...
- Initialising an empty cloned non-pass repo is now possible. This lead to an app crash before. The repo to be cloned should however already have at least one commit, e. g. an added and removed dummy file
