...
- In case of file (`.../example.org/john@doe.org.gpg`) and dir-based (`.../example.org/john@doe.org/password.gpg`) password file organisation, the subfolder structure is now preserved when modifying the suggested destination folder on the "New password" form
